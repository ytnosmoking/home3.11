      ...
      <el-card class="box-card">
        ...
        <div style="margin-bottom:50px;">
          <el-col :span="4" class="text-center">
            <span class="pan-btn blue-btn">Components</span>
          </el-col>
          <el-col :span="4" class="text-center">
            <span class="pan-btn light-blue-btn" >Charts</span>
          </el-col>
          <el-col :span="4" class="text-center">
            <span class="pan-btn pink-btn" >Excel</span>
          </el-col>
          <el-col :span="4" class="text-center">
            <span class="pan-btn green-btn" >Table</span>
          </el-col>
          <el-col :span="4" class="text-center">
            <span class="pan-btn tiffany-btn" >Form</span>
          </el-col>
          <el-col :span="4" class="text-center">
            <span class="pan-btn yellow-btn" >Theme</span>
          </el-col>
        </div>
      </el-card>
    </el-row>
