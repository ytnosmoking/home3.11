...
},
{
  ...
  //     children: [{
  //         path: '/work/work1',
  //         component: _importView("Work/work1"),
  //         name: '房源',
  //         meta: {
  //           title: 'work1',
  //           icon: 'work1'
  ...
  //       {
  //         path: '/work/work2',
  //         component: _importView("Work/work2"),
  //         name: '可租',
  //         meta: {
  //           title: 'work2',
  //           icon: 'work2'
  ...
  //       {
  //         path: '/work/work3',
  //         component: _importView("Work/work3"),
  //         name: '推广',
  //         meta: {
  //           title: 'work3',
  //           icon: 'work3'
